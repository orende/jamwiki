...
The modern way of running this application is by deploying it to a Tomcat instance running in Docker.
    ...
    docker run -d --rm -v ./jamwiki-war/target/jamwiki-$VERSION.war:/usr/local/tomcat/webapps/jamwiki.war -p 8888:8080 tomcat:9.0.108-jdk17-temurin-noble

Then navigate to http://localhost:8080/jamwiki in a browser.
