...
public class ParserTest extends JAMWikiUnitTest {
	...
	public void testCategory() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("WikiCategory");
	...
	public void testCategoryNested() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("TemplateIncludeCategory");
	...
	public void testCategoryTemplate1() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("TemplateCategory1");
		assertEquals("Expected one category", 1, parserOutput.getCategories().size());
	...
	public void testCategoryTemplate2() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("TemplateCategory2");
		assertEquals("Expected two categories", 2, parserOutput.getCategories().size());
		assertNotNull("Category:Test Example1 expected", parserOutput.getCategories().containsKey("Category:Test Example1"));
	...
	public void testInterwiki1() throws Throwable {
		...
		String parserResult = ParserTestUtils.parseForStringResult(parserOutput, "InterWiki1");
	...
	public void testSubst() throws Throwable {
		...
		String contents1 = ParserUtil.parseMinimal(ParserTestUtils.parserInput(TOPIC1_NAME), topic1.getTopicContent());
	...
	public void testVirtualWiki1() throws Throwable {
		...
		ParserOutput parserOutput = new ParserOutput();
		String parserResult = ParserTestUtils.parseForStringResult(parserOutput, "WikiLink1");
	...
	public void testVirtualWiki2() throws Throwable {
		ParserOutput parserOutput = new ParserOutput();
		String parserResult = ParserTestUtils.parseForStringResult(parserOutput, "VirtualWiki1");
	...
	public void testMagicWordDisplayTitleValid() throws Throwable {
		...
		ParserInput parserInput = ParserTestUtils.parserInput(topicName);
		ParserOutput parserOutput = new ParserOutput();
	...
	public void testParseEditComment() throws Throwable {
		...
		ParserInput parserInput = ParserTestUtils.parserInput("Example1");
		String parsedOutput;
		int i = 0;
	...
	public void testParserNoJavascript() throws IOException {
		...
		ParserTestUtils.parseAllResults(TestFileUtil.TEST_RESULTS_DIR, KNOWN_FAILURES);
	}
	...
	public void testParserWithJavascript() throws IOException {
		...
		ParserTestUtils.parseAllResults(TestFileUtil.TEST_JS_RESULTS_DIR, KNOWN_FAILURES);
	}

	@Test
	public void testRedirectCategory1() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("Redirect4");
	...
	public void testRedirectCategory2() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("Category:Redirected");
	...
	public void testRedirectWithSection() throws Throwable {
		ParserOutput parserOutput = ParserTestUtils.parseForParserOutput("Redirect5");
