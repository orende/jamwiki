...
public class DatabaseUtils {
	...
	private static void createTables(QueryHandler handler, Connection conn) throws SQLException {
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_VIRTUAL_WIKI_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_USERS_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_WIKI_USER_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_WIKI_USER_LOGIN_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_USER_PREFERENCES_DEFAULTS_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_USER_PREFERENCES_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_USER_PREFERENCES_WIKI_USER_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_NAMESPACE_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_NAMESPACE_TRANSLATION_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_PAGE_NAME_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_PAGE_NAME_LOWER_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_NAMESPACE_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VIRTUAL_WIKI_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_CURRENT_VERSION_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VERSION_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VERSION_TOPIC_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VERSION_PREVIOUS_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VERSION_USER_DISPLAY_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_VERSION_USER_ID_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_CURRENT_VERSION_CONSTRAINT" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_LINKS_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_TOPIC_LINKS_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_WIKI_FILE_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_WIKI_FILE_VERSION_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_CATEGORY_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_CATEGORY_INDEX" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_GROUP_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_GROUP_MEMBERS_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_ROLE_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_AUTHORITIES_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_GROUP_AUTHORITIES_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_LOG_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_RECENT_CHANGE_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_WATCHLIST_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_INTERWIKI_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_CONFIGURATION_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_USER_BLOCK_TABLE" , conn);
		DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_FILE_DATA_TABLE" , conn);
		String sequenceSql = handler.sql("STATEMENT_CREATE_SEQUENCES");
		if (!StringUtils.isBlank(sequenceSql)) {
			DatabaseUtils.executeUpdate(handler, "STATEMENT_CREATE_SEQUENCES" , conn);
		}
	}
	...
	private static void dropTables(QueryHandler handler, Connection conn) {
		...
		if (!StringUtils.isBlank(sequenceSql)) {
			DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_SEQUENCES" , conn);
		}
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_FILE_DATA_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_USER_BLOCK_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_CONFIGURATION_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_INTERWIKI_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_WATCHLIST_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_RECENT_CHANGE_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_LOG_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_GROUP_AUTHORITIES_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_AUTHORITIES_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_ROLE_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_GROUP_MEMBERS_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_GROUP_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_CATEGORY_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_WIKI_FILE_VERSION_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_WIKI_FILE_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_TOPIC_LINKS_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_TOPIC_CURRENT_VERSION_CONSTRAINT" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_TOPIC_VERSION_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_TOPIC_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_NAMESPACE_TRANSLATION_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_NAMESPACE_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_WIKI_USER_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_USERS_TABLE" , conn);
		DatabaseUtils.executeUpdateNoException(handler, "STATEMENT_DROP_VIRTUAL_WIKI_TABLE" , conn);
	}
	...
	private static void executeUpdateNoException(QueryHandler handler, String property, Connection conn) {
		try {
			DatabaseUtils.executeUpdate(handler, property, conn);
		} catch (SQLException e) {
			// suppress
		}
	}
	 ...
	 * namespace names.
	 */
	public static int fixIncorrectTopicNamespaces(DataHandler dataHandler) {
		int count = 0;
		...
		for (VirtualWiki virtualWiki : virtualWikis) {
			topicNames = dataHandler.queryHandler().lookupTopicNames(virtualWiki.getVirtualWikiId(), true);
			...
			dataHandler.queryHandler().updateTopicNamespaces(topics);
	...
	public static void migrateDatabase(Properties props, List<WikiMessage> errors) {
		...
		// find the QueryHandler appropriate to the NEW database
		QueryHandler newQueryHandler = DatabaseUtils.findNewQueryHandler(props);
		...
		try {
			...
			conn = DatabaseUtils.initializeNewDatabase(props, errors, newQueryHandler);
			if (conn == null) {
				return;
			}
			...
			Map<Integer, Integer> topicVersions = new HashMap<>();
			for (int i = 0; i < JAMWIKI_DB_TABLE_INFO.length; i++) {
				...
				int maxIndex = DatabaseUtils.retrieveMaximumTableId(JAMWIKI_DB_TABLE_INFO[i][0], JAMWIKI_DB_TABLE_INFO[i][1]);
			...
			try {
				DatabaseUtils.dropTables(newQueryHandler, conn);
			} catch (Exception ex) {
	 ...
	 *
	 */
	protected static String getConnectionValidationQuery(DataHandler dataHandler) {
        if (dataHandler == null) {
            return "SELECT 1";
        }
        var CONNECTION_VALIDATION_QUERY = dataHandler.queryHandler().connectionValidationQuery();
    ...
    logger.warn("Failed to close db connection", ex);
}
			}
		...
		try {
			DatabaseUtils.createTables(newQueryHandler, conn);
		} catch (Exception e) {
			logger.error("Error attempting to migrate the database", e);
			errors.add(new WikiMessage("error.unknown", e.getMessage()));
			try {
	 ...
	 */
	protected static void purgeData(Connection conn, DataHandler dataHandler) {
		// BOOM!  Everything gone...
		DatabaseUtils.dropTables(dataHandler.queryHandler(), conn);
		try {
			// re-create empty tables
			DatabaseUtils.createTables(dataHandler.queryHandler(), conn);
		} catch (Exception e) {
	...
	protected static String readSpecialPage(Locale locale, String pageName) throws IOException {
		...
		if (!StringUtils.isBlank(language) && !StringUtils.isBlank(country)) {
			try {
				subdirectory = DatabaseUtils.SPECIAL_PAGE_DIR + File.separator + language + "_" + country;
		...
		if (contents == null && !StringUtils.isBlank(language)) {
			try {
				subdirectory = DatabaseUtils.SPECIAL_PAGE_DIR + File.separator + language;
				filename = subdirectory + File.separator + WikiUtil.encodeForFilename(pageName) + ".txt";
				contents = ResourceUtil.readFile(filename);
			} catch (IOException e) {
		...
		if (contents == null) {
			try {
				subdirectory = DatabaseUtils.SPECIAL_PAGE_DIR;
				filename = subdirectory + File.separator + WikiUtil.encodeForFilename(pageName) + ".txt";
				contents = ResourceUtil.readFile(filename);
			} catch (IOException e) {
	 ...
	 */
	public static int[] rebuildTopicMetadata(DataHandler dataHandler) {
		int numErrors = 0;
		int numUpdated = 0;
		...
		List<VirtualWiki> virtualWikis = dataHandler.getVirtualWikiList();
		for (VirtualWiki virtualWiki : virtualWikis) {
			topicNames = dataHandler.getAllTopicNames(virtualWiki.getName(), false);
			if (topicNames.isEmpty()) {
				continue;
			}
			for (String topicName : topicNames) {
				try {
					topic = dataHandler.lookupTopic(virtualWiki.getName(), topicName, false);
					if (topic == null) {
					...
					dataHandler.writeTopic(topic, null, parserOutput.getCategories(), parserOutput.getLinks());
					numUpdated++;
	 ...
	 *
	 */
	protected static void setup(final Locale locale, final WikiUser user, final String username, final String encryptedPassword, DataHandler dataHandler) throws WikiException {
		try {
				...
				new TransactionCallbackWithoutResult() {
					protected void doInTransactionWithoutResult(TransactionStatus status) {
						...
						try {
							...
							// set up tables
							DatabaseUtils.createTables(dataHandler.queryHandler(), conn);
							DatabaseUtils.setupDefaultVirtualWiki(dataHandler);
							DatabaseUtils.setupDefaultNamespaces(dataHandler);
							DatabaseUtils.setupDefaultInterwikis(dataHandler);
							DatabaseUtils.setupRoles(dataHandler);
							DatabaseUtils.setupGroups(dataHandler);
							DatabaseUtils.setupUserPreferencesDefaults(dataHandler);
							DatabaseUtils.setupAdminUser(user, username, encryptedPassword, dataHandler);
							DatabaseUtils.setupSpecialPages(locale, user, dataHandler);
						} catch (IOException e) {
							status.setRollbackOnly();
							logger.error("Unable to set up database tables", e);
							rollbackAfterSetupFailure(dataHandler);
	 ...
	 *
	 */
	private static void rollbackAfterSetupFailure(DataHandler dataHandler) {
	 ...
	 *
	 */
	private static void setupAdminUser(WikiUser user, String username, String encryptedPassword, DataHandler dataHandler) throws WikiException {
		...
		if (dataHandler.lookupWikiUser(user.getUserId()) != null) {
			logger.warn("Admin user already exists");
		}
        var registeredUsersGroup = dataHandler.lookupWikiGroup(WikiGroup.GROUP_REGISTERED_USER);
		dataHandler.writeWikiUser(user, username, encryptedPassword, registeredUsersGroup);
		...
		dataHandler.writeRoleMapUser(user.getUsername(), roles);
	}
	 ...
	 *
	 */
	private static void setupDefaultInterwikis(DataHandler dataHandler) throws WikiException {
	...
	private static void setupDefaultNamespaces(DataHandler dataHandler) throws WikiException {
		...
		for (int i = 0; i < defaultNamespaces.length; i++) {
			...
			dataHandler.writeNamespace(mainNamespace);
			...
			if (defaultNamespaces.length > (i + 1)) {
				...
				if (mainNamespace.getId().equals(commentsNamespace.getMainNamespaceId())) {
					dataHandler.writeNamespace(commentsNamespace);
					i++;
				}
			}
		}
	 ...
	 *
	 */
	private static void setupDefaultVirtualWiki(DataHandler dataHandler) throws WikiException {
	 ...
	 *
	 */
	protected static void setupGroups(DataHandler dataHandler) throws WikiException {
		...
		dataHandler.writeWikiGroup(group);
		...
		dataHandler.writeRoleMapGroup(group.getGroupId(), anonymousRoles);
		...
		dataHandler.writeRoleMapGroup(group.getGroupId(), userRoles);
	}

	/**
	 *
	 */
	protected static void setupRoles(DataHandler dataHandler) throws WikiException {
		...
		dataHandler.writeRole(role, false);
	 ...
	 *
	 */
	protected static void setupSpecialPage(Locale locale, String virtualWiki, String topicName, WikiUser user, boolean adminOnly, boolean readOnly, DataHandler dataHandler) throws IOException, WikiException {
		...
		String contents = DatabaseUtils.readSpecialPage(locale, topicName);
		...
		// dataHandler.writeTopic(topic, topicVersion, parserOutput.getCategories(), parserOutput.getLinks());
	 ...
	 *
	 */
	private static void setupSpecialPages(Locale locale, WikiUser user, DataHandler dataHandler) throws IOException, WikiException {
		List<VirtualWiki> all = dataHandler.getVirtualWikiList();
		for (VirtualWiki virtualWiki : all) {
			// create the default topics
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_STARTING_POINTS, user, false, false, dataHandler);
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_SIDEBAR, user, true, false, dataHandler);
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_FOOTER, user, true, false, dataHandler);
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_HEADER, user, true, false, dataHandler);
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_SYSTEM_CSS, user, true, true, dataHandler);
			setupSpecialPage(locale, virtualWiki.getName(), WikiBase.SPECIAL_PAGE_CUSTOM_CSS, user, true, false, dataHandler);
		}
	}
	...
	protected static void setupUserPreferencesDefaults(DataHandler dataHandler) throws WikiException {
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_DEFAULT_LOCALE, Locale.getDefault().toString(), WikiUser.USER_PREFERENCES_GROUP_INTERNATIONALIZATION, 1);
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_TIMEZONE, TimeZone.getDefault().getID(), WikiUser.USER_PREFERENCES_GROUP_INTERNATIONALIZATION, 2);
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_DATE_FORMAT, WikiConfiguration.getInstance().getDateFormats().get(0), WikiUser.USER_PREFERENCES_GROUP_INTERNATIONALIZATION, 3);
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_TIME_FORMAT, WikiConfiguration.getInstance().getTimeFormats().get(0), WikiUser.USER_PREFERENCES_GROUP_INTERNATIONALIZATION, 4);
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_PREFERRED_EDITOR, "toolbar", WikiUser.USER_PREFERENCES_GROUP_EDITING, 1);
		dataHandler.writeUserPreferenceDefault(WikiUser.USER_PREFERENCE_SIGNATURE, null, WikiUser.USER_PREFERENCES_GROUP_EDITING, 2);
	}
}
