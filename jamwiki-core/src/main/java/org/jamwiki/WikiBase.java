...
public class WikiBase {
	...
	public static final WikiCache<String, String> CACHE_PARSED_TOPIC_CONTENT = new WikiCache<>("org.jamwiki.WikiBase.CACHE_PARSED_TOPIC_CONTENT", String.class, String.class);
